...
def preprocess_data(df):
    numeric_columns = [
        'taux_evolution_due_solde_migratoire',
...
sns.pairplot(data[['taux_evolution_due_solde_migratoire', 'nombre_d_equipements_culturels', 'nombre_d_equipements_sportifs', 'nombre_de_festivals']])
st.pyplot(plt.gcf())
plt.clf()
...
corr_matrix = data[['taux_evolution_due_solde_migratoire', 'nombre_d_equipements_culturels', 'nombre_d_equipements_sportifs', 'nombre_de_festivals']].corr()
...
y = data['taux_evolution_due_solde_migratoire']
